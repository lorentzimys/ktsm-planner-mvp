  ...
  return (
    <div className='flex flex-1 place-content-center self-center'>
      <div className='flex flex-col align-middle gap-2 p-10 border-dashed border-slate-700 border-2 ratio-16x9'>
        ...
        <button onClick={handleClickUpload} className="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">
          Загрузите файл
        </button>
      </div>
    </div>
